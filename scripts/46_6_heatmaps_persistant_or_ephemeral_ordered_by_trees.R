...
# ## fix scale, 
# font size,
# label label instead of having legend, 
...
make_heatmap_with_persistant_and_ephemeral_otus <- function (OTU_table_with_isolates_pers,
 ...
 OTU_heatmap <- ggplot(OTU_table_pers_and_eph, 
  ...
  geom_tile(data=na.omit(OTU_table_pers_and_eph), aes(fill = group), size=4) +
  scale_fill_discrete(labels=c("Ephemeral", "Persistent"))+
  theme_JAG_presentation()
 ##fix up formatting
...
make_label_for_heatmap_based_on_tree_ordering_with_annotations <- function (OTU_table_with_isolates,
 ...
 CSTColorScale <- scale_colour_manual(name = "group", values = colour_palette)
 CSTFillScale <- scale_fill_manual(name = "group", values = colour_palette)
 
 hcb <- make_hcb(annotations_reordered , "group", name="group", fillScale = CSTFillScale)
...
MPL_pers_and_eph_heatmap <- MPL_pers_and_eph_heatmap+ annotate("text", x = missing_MPL_dates, y = 0.00, label="*", size=12)
...
MPL_colour <- c("grey", mypalette, "white")



p1<- MPL_pers_and_eph_heatmap +  theme(axis.title.y=element_blank(), axis.ticks=element_blank()) +
...
make_heatmap_based_on_tree_ordering_high_res_view(normalized_MPL_OTUs_only_high_res_with_isolates,
                                                  RdRp_95_ref_tree, 
                                                  "../figures/MPL_95_miseq_data_heatmap_only_high_res.pdf")
...
#  
#  plot(gp23_95_ref_tree_top_100)
#  
#  gp23_otu_table_top_100_with_isolates <- add_isolates_to_otu_table(gp23_95_ref_tree_top_100, normalized_gp23_OTUs_top_100)
#  
#  plot_tree(gp23_95_ref_tree_top_100,"../figures/gp23_95_miseq_data_top_100_with_env_iso_and_ref_Raxml.pdf")
#  
#  make_heatmap_based_on_tree_ordering(gp23_otu_table_top_100_with_isolates,
#                                      gp23_95_ref_tree_top_100, 
#                                      "../figures/gp23_tree_top_100_heatmap_ggplot.pdf")
#  
...
#  
#  plot(gp23_95_only_miseq)
#  
#  plot_tree(gp23_95_only_miseq,                                                         "../figures/gp23_95_miseq_data_Raxml.pdf")
#  
#  make_heatmap_based_on_tree_ordering(normalized_gp23_OTUs,
#                                      gp23_95_only_miseq, 
#                                      "../figures/gp23_95_tree_only_miseq_heatmap_ggplot.pdf")
#  
...
make_heatmap_with_persistant_medium_and_ephemeral_otus(S18_otu_table_for_persistant_no_high_res,
                                                       S18_otu_table_for_med_no_high_res,
                                                       S18_otu_table_for_ephemeral_no_high_res,
                                                       S18_tree, 
                                                       "../figures/S18_miseq_data_heatmap_persistant_medium_and_ephemeral_no_high_res.pdf")
...
S16_otu_table_for_med_no_high_res <- get_otu_table_highlighting_medium_otus(normalized_16s_OTUs_no_high_res)

make_heatmap_with_persistant_medium_and_ephemeral_otus(S16_otu_table_for_persistant_no_high_res,
                                                       S16_otu_table_for_med_no_high_res,
                                                       S16_otu_table_for_ephemeral_no_high_res,
                                                       S16_tree, 
                                                       "../figures/S16_miseq_data_heatmap_persistant_medium_and_ephemeral_no_high_res.pdf")
