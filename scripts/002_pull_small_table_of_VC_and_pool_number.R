...
S18_data <- c(S18_data, "1223_redo", "1225_redo")
...
write.csv(S18_data, "../results/18s_VC_number_with_pool.csv")


S16_data <- c()
S16_data <- as.character(Jericho_data$VC_number)

S16_data <- c(S16_data, "1223_redo", "1225_redo")
...
write.csv(S16_data, "../results/16s_VC_number_with_pool.csv")
