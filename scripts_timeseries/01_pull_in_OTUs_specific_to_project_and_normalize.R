...
AllOTUs_rarefied_iteration <- lapply(as.list(1:3), 
 ...
 ## transpose the rarefied otu table 
...
# OTU_table_16s <- read.delim("../../Miseq_Initial_Run_Processing/results/Divided_by_primers/All_libs_combined/Translated/Picked_OTUs/Total_16s_concat_annotated.good.good.ng_otus_97.00global_OTU_table.tsv", row.names = 1, header=TRUE)
# 
