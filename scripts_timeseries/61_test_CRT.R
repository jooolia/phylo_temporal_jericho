...
SimpleRareToPrev.f(otu_fp="../data/OTU_table_Jericho_time_series_normalized_16S_R1.tsv",
                   abund_thresh=0.005,
                   abund_thresh_ALL=FALSE,
                   b_thresh=0.90, 
                   rdp_lastcol=FALSE)

SimpleRareToPrev.f(otu_fp="../data/OTU_table_Jericho_time_series_normalized_18S.tsv",
                   abund_thresh=0.005,
                   abund_thresh_ALL=FALSE,
                   b_thresh=0.90, 
                   rdp_lastcol=FALSE)
