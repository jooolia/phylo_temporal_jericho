...
subset_to_transform <- subset(mean_imputed_Jericho_Pier, select = colnames(mean_imputed_Jericho_Pier) %in% to_keep)

# 
# plot(mean_imputed_Jericho_Pier$Temperature_YSI, eruption.res, 
#             ylab="Residuals", xlab="Temperature_YSI", 
