...
#head $normalized_otu_table_top_10 -n 1 | sed s/\"//g > top_10_OTUs.txt
	...
	oligotype ../results/$file"_"$OTU"like_reads_aligned_new_names.fasta" ../results/$file"_"$OTU"like_reads_aligned_new_names.fasta-ENTROPY" -c 1 -A 10 -M 50 -o ../results/"oligotyping"$file"_"$OTU"like_reads"/ --gen-html 
