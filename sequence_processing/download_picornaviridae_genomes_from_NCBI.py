...
search_handle = Entrez.esearch(db="nucleotide", term="Picornavirales[ORGN] AND complete genome", usehistory="y")
...
batch_size = 3
out_handle = open("../data/MPL_sequence_references/picornavirales_complete_genomes_downloaded.fasta", "w")
print(out_handle)
