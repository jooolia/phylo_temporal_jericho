...
#  Project_data <- gp23_data
 ...
 transposed_table_removed_OTUs_no_longer_present$VC_number <-  as.character(transposed_table_project_only$VC_number)
...
normalize_otu_table_by_project <-  function (amplicon_time_series,
 ...
 write.table(amplicon_time_series,
             paste("../data/OTU_table_bloom_time_series_",
                   amplicon, 
                   ".tsv",
                   sep=""),
             sep="\t",
 ...
 write.table(OTU_table_time_series_normalized_amplicon, 
             paste("../data/OTU_table_bloom_time_series_normalized_", 
                   amplicon, 
                   ".tsv", 
                   sep=""), 
             sep="\t",
...
colSums(get_project_data_MPL[,-dim(get_project_data_MPL)[2]])
...
S18_data <- c(S18_data, "1256_ctab", "1255_large")
