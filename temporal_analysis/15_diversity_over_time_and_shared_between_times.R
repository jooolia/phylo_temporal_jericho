...
pdf("../figures/time_series_community_similarity_all_amplicons_with_phytos_and_het_line_graphs%03d.pdf", width = 20, height = 15, onefile = FALSE)
grid.arrange(community_sim_over_time_MPL,
             community_sim_over_time_18s,
             community_sim_over_time_18s_phytos,
             community_sim_over_time_18s_hetero,
...
pdf("../figures/time_series_community_similarity_lagged_virus_all_amplicons_line_graphs%03d.pdf", width = 20, height = 15, onefile = FALSE)
