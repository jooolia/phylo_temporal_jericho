...
find_top100_OTUs <- function (normalized_otus) {
 ...
 top_100_OTUs <- droplevels(subset(normalized_otus,
                                   select=colnames(normalized_otus) %in% vector_top_100_OTUs$variable))
 return(top_100_OTUs)
}
...
find_top10_OTUs <- function (normalized_otus) {
 ...
 top_10_OTUs <- droplevels(subset(normalized_otus,
                                  select=colnames(normalized_otus) %in% vector_top_10_OTUs$variable))
 return(top_10_OTUs)
} 
